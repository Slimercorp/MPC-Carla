...
try:
    while True:
        ...
        x0, y0, theta0, v0 = carla.get_main_vehicle_state()
        ...
        logger.log_control_input(x0, y0, v0, theta0, x_ref[0], y_ref[0], V_REF, theta_ref[0])
        ...
        logger.log_control_output(steer, throttle, brake)
